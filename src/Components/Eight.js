function largestProductinaSeries(n) {
    ...
    for(let i = 0; i <= 1000 - n; i++){
      cummulator = thousandDigits.slice(i, [i + n]);
      console.log(cummulator)
      let currentProduct = cummulator.reduce((a, b) => a * b)
      if(currentProduct >= biggestProduct){
        biggestProduct = currentProduct
      }
    }
  
    //multiply first 4 and total sum
    //splice the four numbers splice(index, how many)
    //compare current sum to current leader 
